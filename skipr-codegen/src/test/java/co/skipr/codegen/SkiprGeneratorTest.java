 ...
 * 1) Set a break point in SkiprGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class SkiprGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new CodegenConfigurator()
              .setGeneratorName("skipr") // use this codegen library
              ...
              .setOutputDir("out/skipr"); // output directory
